  ...
  <main>
      ...
      <div class="gallery">
        ...
        <div class="gallery-images" id="gallery">
          ...
          <?php
            ...
            $commandText = "SELECT * FROM `jersey` WHERE name='statement'";
    ...
    <div class="text-container-odd">
      <div class="title-text-odd">
        <span class="big-title-text">STATEMENT</span>
        <span class="small-title-text">Edition</span>
      </div>
      <div class="description-text-odd">
        <span>Heard through actions with self-made style. Self-proven but selfless, and not afraid to zig when they zag.  </span>
      </div>
      <div class="button-container-odd">
        <a href="https://shop.realsports.ca/products/the-statement-edition" class="realSports-btn-odd">Real Sports Shop</a>
      </div>
    </div>
  </main>
