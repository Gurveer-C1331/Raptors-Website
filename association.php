  ...
  <main>
      ...
      <div class="gallery">
        ...
        <div class="gallery-images" id="gallery">
          ...
          <?php
            ...
            $commandText = "SELECT * FROM `jersey` WHERE name='association'";
    ...
    <div class="text-container-odd">
      <div class="title-text-odd">
        <span class="big-title-text">ASSOCIATION</span>
        <span class="small-title-text">Edition</span>
      </div>
      <div class="description-text-odd">
        <span>A beacon of solidarity, uniting 5 on the floor, 11 on the bench and a fanbase across the globe. This is True North. </span>
      </div>
